  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=" treeview{{ session('lsbm') == 'pages' ? ' active ' : '' }}">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ session('lsbsm') == 'pagesAll' ? ' active ' : '' }}"><a href="{{route('admin.pagesAll')}}"><i class="fa fa-circle-o"></i> Pages All </a></li>
          </ul>
        </li>
 ...
 --}}
            ...
            {{-- <li class="{{ session('lsbsm') == 'aboutPostAddNew' ? 'active' : '' }}"><a class=" "  href="{{route('admin.aboutPostAddNew')}}"><i class="fa fa-circle-o"></i> Add New About-Post (About Page)</a></li>
            <li class="{{ session('lsbsm') == 'aboutPostAll' ? 'active' : '' }}"><a class=" "  href="{{route('admin.aboutPostAll')}}"><i class="fa fa-circle-o"></i> All About-Post (About Page)</a></li>

            <li class="{{ session('lsbsm') == 'authorPostAddNew' ? 'active' : '' }}"><a class=" "  href="{{route('admin.authorPostAddNew')}}"><i class="fa fa-circle-o"></i> Add New Author-Post (About Page)</a></li>
            <li class="{{ session('lsbsm') == 'authorPostAll' ? 'active' : '' }}"><a class=" "  href="{{route('admin.authorPostAll')}}"><i class="fa fa-circle-o"></i> All Author-Post (About Page)</a></li>
            <li class="{{ session('lsbsm') == 'servicePostAddNew' ? 'active' : '' }}"><a class=" "  href="{{route('admin.servicePostAddNew')}}"><i class="fa fa-circle-o"></i> Add New Service-Post (Home Page)</a></li>


            <li class="{{ session('lsbsm') == 'servicePostAll' ? 'active' : '' }}"><a class=" "  href="{{route('admin.servicePostAll')}}"><i class="fa fa-circle-o"></i> All Service-Post (Home Page)</a></li>

            <li class=""><a class=" "  href="{{route('admin.editPage',10)}}"><i class="fa fa-circle-o"></i> Welcome Text (Home Page)</a></li>
 --}}
          </ul>
        </li>
        ...
        <li class="treeview {{ session('lsbm') == 'report' ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ session('lsbsm') == 'reportsAll' ? 'active' : '' }}"><a class="changed-menu" href="{{route('admin.reportsAll')}}"><i class="fa fa-circle-o"></i> All Reports</a></li>
          </ul>
        </li>
        ...
        <li class="treeview  {{ session('lsbm') == 'sms' ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="{{ session('lsbsm') == 'sendEmailSmsToUsers' ? ' active ' : '' }}"><a  href="{{route('admin.sendEmailSmsToUsers')}}"><i class="fa fa-circle-o"></i>Send Email Sms to Users</a></li>

            <li  class="{{ session('lsbsm') == 'sendProfileToGivenEmail' ? ' active ' : '' }}"><a  href="{{route('admin.sendProfileToGivenEmail')}}"><i class="fa fa-circle-o"></i>Send Profile to Given Email</a></li>

            <li  class="{{ session('lsbsm') == 'sendCvToGivenEmail' ? ' active ' : '' }}"><a  href="{{route('admin.sendCvToGivenEmail')}}"><i class="fa fa-circle-o"></i>Send CV to Given Email</a></li>

            
          </ul>
        </li>
        {{-- message to admin --}}
        <li class="treeview  {{ session('lsbm') == 'adminMessage' ? 'active' : '' }}">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li  class="{{ session('lsbsm') == 'requestCallBack' ? ' active ' : '' }}"><a href="{{route('admin.callback')}}"><i class="fa fa-fw fa-envelope"></i>Request Call Back Messages</a></li>
          </ul>
        </li>
        ...
        <li class="treeview {{ session('lsbm') == 'users' ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ session('lsbsm') == 'newUser' ? 'active' : '' }}"><a class="changed-menu" href="{{route('admin.newUser')}}"><i class="fa fa-circle-o"></i> Create New User</a></li> 

            <li class="{{ session('lsbsm') == 'offline_user' ? 'active' : '' }}"><a class="changed-menu" href="{{route('admin.usersGroup','offline_user')}}"><i class="fa fa-circle-o"></i> All Offline Users</a></li> 
            ...
            <li class="{{ session('lsbsm') == 'inactive_male_users' ? 'active' : '' }}"><a class="changed-menu" href="{{route('admin.usersGroup','inactive_male_users')}}"><i class="fa fa-circle-o"></i>Male Deactivated Users</a></li>

            <li class="{{ session('lsbsm') == 'inactive_female_users' ? 'active' : '' }}"><a class="changed-menu" href="{{route('admin.usersGroup','inactive_female_users')}}"><i class="fa fa-circle-o"></i>Female Deactivated Users</a></li>
