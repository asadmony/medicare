...
{{-- <div class="row">
  <div class="col-sm-6">
    <div class="card card-widget">
    <div class="card-header with-border">
      <h3 class="card-title">Update Sub Image of  About Page </h3>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-sm-8">
  ...
  <div class="col-sm-6">
    <div class="card card-widget">
    <div class="card-header with-border">
      <h3 class="card-title">Update Sub Image of  Story Page </h3>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-sm-8">
...
<div class="row">
  <div class="col-sm-6">
    <div class="card card-widget">
    <div class="card-header with-border">
      <h3 class="card-title">Update Sub Image of  Contact Page </h3>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-sm-8">
  ...
  <div class="col-sm-6">
    <div class="card card-widget">
    <div class="card-header with-border">
      <h3 class="card-title">Update Sub Image of  Package Page </h3>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-sm-8">
